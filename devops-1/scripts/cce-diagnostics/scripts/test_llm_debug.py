...
async def test_multiple_calls():
    ...
    try:
        ...
        test_prompts = [
            {
                "CCE_ID": "CCE-0001",
                "prompt": "Linux root 계정 원격 접속 제한에 대한 보안 분석을 해주세요."
            },
            {
                "CCE_ID": "CCE-0002", 
                "prompt": "Linux 패스워드 복잡도 설정에 대한 보안 분석을 해주세요."
            },
            {
                "CCE_ID": "CCE-0003",
                "prompt": "Linux 파일 권한 설정에 대한 보안 분석을 해주세요."
            },
            {
                "CCE_ID": "CCE-0004",
                "prompt": "Linux 패스워드 최대 사용 기간 설정에 대한 보안 분석을 해주세요."
            },
            {
                "CCE_ID": "CCE-0005",
                "prompt": "Linux 패스워드 파일 보호에 대한 보안 분석을 해주세요."
            }
        ]
